...
async function seed() {
  ...
  const accountDefs = [
    ...
    { Name: 'Foxconn', Industry: 'Electronics', AnnualRevenue: 222000000000, BillingCity: 'New Taipei City', NumberOfEmployees: 1000000, Phone: '+886-2-2268-3466', Description: 'SKYPURA 전자제품 하우징/SKYTRA E&E 부품 대만 공급. 애플 제품 친환경 소재 전환 대응.' },
  ...
  const leadDefs = [
    ...
    { FirstName: 'Farouk', LastName: 'Ibrahim', Company: 'Qatar Petrochemical', Email: 'f.ibrahim@qapco.com', Title: 'Chemical Procurement Manager', Status: 'Open - Not Contacted', LeadSource: 'Trade Show', Rating: 'Warm', Phone: '+974-4477-0000', Description: 'SKYDMT 카타르 석유화학 원료 공급 탐색. 중동 폴리에스터 시장 진출 검토.' },
    ...
    { FirstName: 'Thabo', LastName: 'Nkosi', Company: 'Sasol Limited', Email: 't.nkosi@sasol.com', Title: 'Chemical Raw Material Sourcing', Status: 'Open - Not Contacted', LeadSource: 'Cold Call', Rating: 'Cold', Phone: '+27-10-344-5000', Description: 'SKYDMT 아프리카 화학 원료 공급 탐색. 남아프리카 화학 산업 원료 다변화.' },
    { FirstName: 'Leila', LastName: 'Ahmadi', Company: 'National Petrochemical Iran', Email: 'l.ahmadi@npc.ir', Title: 'Polyester Raw Material Manager', Status: 'Open - Not Contacted', LeadSource: 'Web', Rating: 'Warm', Phone: '+98-21-6641-0000', Description: 'SKYDMT 이란 폴리에스터 원료 공급 탐색. 중동 폴리에스터 시장 진출 검토.' },
    ...
    { FirstName: 'Nadia', LastName: 'Khalil', Company: 'Egyptian Petrochemicals', Email: 'n.khalil@egpc.com.eg', Title: 'Chemical Procurement Manager', Status: 'Open - Not Contacted', LeadSource: 'Web', Rating: 'Cold', Phone: '+20-2-2792-0000', Description: 'SKYDMT 이집트 석유화학 원료 공급 탐색. 아프리카 폴리에스터 시장 진출 초기 검토.' },
    ...
    { FirstName: 'Omar', LastName: 'Abdullah', Company: 'Kuwait Petroleum Corp', Email: 'o.abdullah@kpc.com.kw', Title: 'Chemical Division Manager', Status: 'Open - Not Contacted', LeadSource: 'LinkedIn', Rating: 'Warm', Phone: '+965-2244-2444', Description: 'SKYDMT 쿠웨이트 석유화학 원료 공급 탐색. GCC 폴리에스터 시장 진출 검토.' },
    { FirstName: 'Isabella', LastName: 'Fernandez', Company: 'PDVSA Petroquimica', Email: 'i.fernandez@pdvsa.com', Title: 'Chemical Raw Material Lead', Status: 'Open - Not Contacted', LeadSource: 'Cold Call', Rating: 'Cold', Phone: '+58-212-708-4111', Description: 'SKYDMT 중남미 원료 공급 탐색. 베네수엘라 석유화학 원료 시장 초기 검토.' },
    { FirstName: 'Yaw', LastName: 'Asante', Company: 'Ghana Bauxite Company', Email: 'y.asante@ghanabauxite.com', Title: 'Industrial Material Procurement', Status: 'Open - Not Contacted', LeadSource: 'Web', Rating: 'Cold', Phone: '+233-20-123-4567', Description: 'SKYPURA 산업용 내열 소재 문의. 서아프리카 광업 인프라 소재 초기 탐색.' },
