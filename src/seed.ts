...
async function seed() {
  ...
  const accountDefs = [
    ...
    { Name: 'Amorepacific', Industry: 'Consumer Goods', AnnualRevenue: 4100000000, BillingCity: 'Seoul', BillingCountry: 'Korea, Republic of', NumberOfEmployees: 26000, Phone: '+82-2-709-5114', Description: 'SKYGREEN 국내 화장품 용기 장기 공급처. ECOZEN Pro 신규 적용 검토 중.' },
    ...
    // 가전/소비재 (14~18)
    { Name: 'Samsung Electronics', Industry: 'Electronics', AnnualRevenue: 200000000000, BillingCity: 'Suwon', BillingCountry: 'Korea, Republic of', NumberOfEmployees: 270000, Phone: '+82-31-200-1114', Description: 'SKYBON 냉장고/세탁기 강판 코팅 국내 최대 고객사. SKYPURA 전자제품 소재 신규 적용 검토.' },
    { Name: 'LG Electronics', Industry: 'Electronics', AnnualRevenue: 63000000000, BillingCity: 'Seoul', BillingCountry: 'Korea, Republic of', NumberOfEmployees: 74000, Phone: '+82-2-3777-1114', Description: 'SKYBON 가전 강판 코팅 공급처. ECOZEN 친환경 가전 외장재 적용 협의 중.' },
    ...
    // 자동차 (19~24)
    { Name: 'Hyundai Motor', Industry: 'Automotive', AnnualRevenue: 105000000000, BillingCity: 'Seoul', BillingCountry: 'Korea, Republic of', NumberOfEmployees: 120000, Phone: '+82-2-3464-1114', Description: 'SKYPET CR 자동차 카펫/매트, SKYPEL 자동차 부품 국내 최대 자동차 고객. EV 플랫폼 친환경 소재 전환 협력.' },
    ...
    { Name: 'Foxconn', Industry: 'Electronics', AnnualRevenue: 222000000000, BillingCity: 'New Taipei City', BillingCountry: 'China (Taiwan)', NumberOfEmployees: 1000000, Phone: '+886-2-2268-3466', Description: 'SKYPURA 전자제품 하우징/SKYTRA E&E 부품 대만 공급. 애플 제품 친환경 소재 전환 대응.' },
    ...
    { Name: 'POSCO', Industry: 'Manufacturing', AnnualRevenue: 65000000000, BillingCity: 'Pohang', BillingCountry: 'Korea, Republic of', NumberOfEmployees: 18000, Phone: '+82-54-220-0114', Description: 'SKYBON 강판 코일 코팅 수지 국내 최대 공급처. 가전/건설 강판 코팅 소재 장기 공급 계약.' },
    // 섬유/타이어코드 (35~37)
    { Name: 'Hyosung Advanced Materials', Industry: 'Textiles', AnnualRevenue: 3800000000, BillingCity: 'Seoul', BillingCountry: 'Korea, Republic of', NumberOfEmployees: 5200, Phone: '+82-2-707-7000', Description: 'SKYDMT/SKYPET CR 타이어코드 국내 최대 고객. 재활용 PET 타이어코드 적용으로 ESG 성과 창출.' },
  ...
  const leadDefs = [
    ...
    { FirstName: 'Nikolai', LastName: 'Petrov', Company: 'Gazprom Neft', Email: 'n.petrov@gazpromneft.ru', Title: 'Chemical Raw Material Buyer', Status: 'Open - Not Contacted', LeadSource: 'Web', Rating: 'Warm', Country: 'Russian Federation', Phone: '+7-812-363-3000', Description: 'SKYDMT DMT 원료 러시아 공급 문의. 러시아 폴리에스터 시장 진출 탐색.' },
    ...
    { FirstName: '김', LastName: '민준', Company: '삼성물산', Email: 'mj.kim@samsung.com', Title: '친환경 소재 사업개발팀장', Status: 'Working - Contacted', LeadSource: 'Conference', Rating: 'Hot', Country: 'Korea, Republic of', Phone: '+82-2-2145-2114', Description: 'ECOTRIA CR/SKYPET CR 재활용 소재 유통 문의. 삼성물산 친환경 소재 사업 확대.' },
    { FirstName: '이', LastName: '재현', Company: '롯데케미칼', Email: 'jh.lee2@lotte.com', Title: 'ESG 소재 개발 담당', Status: 'Open - Not Contacted', LeadSource: 'Web', Rating: 'Warm', Country: 'Korea, Republic of', Phone: '+82-2-6974-1114', Description: 'SKYDMT/SKYCHDM 폴리에스터 원료 문의. 롯데케미칼 코폴리에스터 사업 협력 탐색.' },
    { FirstName: '박', LastName: '성민', Company: '코오롱인더스트리', Email: 'sm.park@kolon.com', Title: '섬유소재 구매팀장', Status: 'Working - Contacted', LeadSource: 'Trade Show', Rating: 'Hot', Country: 'Korea, Republic of', Phone: '+82-2-3677-3114', Description: 'SKYPET CR 타이어코드/산업용 섬유 원료 문의. 코오롱 재활용 섬유 사업 확대.' },
    { FirstName: '최', LastName: '지훈', Company: '한화케미칼', Email: 'jh.choi@hanwha.com', Title: '화학 원료 구매 담당', Status: 'Open - Not Contacted', LeadSource: 'Cold Call', Rating: 'Cold', Country: 'Korea, Republic of', Phone: '+82-2-729-3114', Description: 'SKYDMT 화학 원료 국내 공급 탐색. 초기 문의 단계.' },
    ...
    { FirstName: 'Nguyen', LastName: 'Van Minh', Company: 'Vingroup JSC', Email: 'nm.nguyen@vingroup.vn', Title: 'Automotive Material Procurement', Status: 'Open - Not Contacted', LeadSource: 'LinkedIn', Rating: 'Warm', Country: 'Viet Nam', Phone: '+84-24-3974-9999', Description: 'SKYPET CR 전기차 내장재 소재 문의. VinFast 전기차 친환경 소재 탐색.' },
    ...
    { FirstName: '홍', LastName: '길동', Company: 'SK이노베이션', Email: 'gd.hong@skinnovation.com', Title: 'ESG 원료 사업개발 담당', Status: 'Open - Not Contacted', LeadSource: 'Conference', Rating: 'Warm', Country: 'Korea, Republic of', Phone: '+82-2-2121-5114', Description: 'ECOTRIA CR 화학재활용 원료 협력 문의. SK그룹 내 순환경제 협력 탐색.' },
    ...
    { FirstName: '나', LastName: '영수', Company: '금호석유화학', Email: 'ys.na@kkpc.com', Title: '폴리에스터 원료 구매팀장', Status: 'Working - Contacted', LeadSource: 'Partner Referral', Rating: 'Hot', Country: 'Korea, Republic of', Phone: '+82-2-6961-1114', Description: 'SKYDMT DMT 원료 국내 공급 협력 문의. 금호석유화학 폴리에스터 원료 다변화.' },
    ...
    { FirstName: 'Park', LastName: 'Jae-won', Company: 'LG Chem', Email: 'jw.park@lgchem.com', Title: '특수화학 원료 소싱 담당', Status: 'Working - Contacted', LeadSource: 'Conference', Rating: 'Hot', Country: 'Korea, Republic of', Phone: '+82-2-3773-1114', Description: 'SKYCHDM/SKYDMCD 특수화학 원료 공급 협력 문의. LG화학 코폴리에스터 포트폴리오 확대.' },
    // 중동/남미/아프리카/기타 (20개)
    ...
    { FirstName: 'Thabo', LastName: 'Nkosi', Company: 'Sasol Limited', Email: 't.nkosi@sasol.com', Title: 'Chemical Raw Material Sourcing', Status: 'Open - Not Contacted', LeadSource: 'Cold Call', Rating: 'Cold', Country: 'South Africa, Republic of', Phone: '+27-10-344-5000', Description: 'SKYDMT 아프리카 화학 원료 공급 탐색. 남아프리카 화학 산업 원료 다변화.' },
    { FirstName: 'Leila', LastName: 'Ahmadi', Company: 'National Petrochemical Iran', Email: 'l.ahmadi@npc.ir', Title: 'Polyester Raw Material Manager', Status: 'Open - Not Contacted', LeadSource: 'Web', Rating: 'Warm', Country: 'Iran, Islamic Republic of', Phone: '+98-21-6641-0000', Description: 'SKYDMT 이란 폴리에스터 원료 공급 탐색. 중동 폴리에스터 시장 진출 검토.' },
    ...
    { FirstName: 'Isabella', LastName: 'Fernandez', Company: 'PDVSA Petroquimica', Email: 'i.fernandez@pdvsa.com', Title: 'Chemical Raw Material Lead', Status: 'Open - Not Contacted', LeadSource: 'Cold Call', Rating: 'Cold', Country: 'Venezuela, Bolivarian Republic of', Phone: '+58-212-708-4111', Description: 'SKYDMT 중남미 원료 공급 탐색. 베네수엘라 석유화학 원료 시장 초기 검토.' },
